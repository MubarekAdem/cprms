...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
      ...
      {/* CTA Section */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl shadow-lg p-8 md:p-12 text-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/signup">
                <Button className="bg-white text-emerald-700 hover:bg-emerald-50 px-8 py-6">
                  Create Account
                </Button>
              </Link>
              <Link href="/demo">
                <Button
                  variant="outline"
                  className="border-white text-white hover:bg-emerald-700 px-8 py-6"
                >
                  Request Demo
                </Button>
              </Link>
